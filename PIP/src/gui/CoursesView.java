...
public class CoursesView extends JPanel {
	...
	public void initComponents() {
		...
		viewAssignments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				assignmentFrame.setTitle(userCourses.get(jListOfCourses.getSelectedIndex()).getTitle() + " Assignments");
	...
	public void setSizes() {
		...
		editCourse.setBounds((WIDTH / 100) * 55, (HEIGHT / 100) * 85, (WIDTH / 100) * 10, 25);
		viewAssignments.setBounds((WIDTH / 100) * 70, (HEIGHT / 100) * 85, (WIDTH / 100) * 10, 25);
		detailedCourse.setBounds((WIDTH / 100) * 85, (HEIGHT / 100) * 85, (WIDTH / 100) * 10, 25);
	}
